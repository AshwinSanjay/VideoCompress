        ...
        try:
            ...
            if user.status == "kicked":
                await message.reply_text(
                    text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/joinchat/kxhQtBfvg4Q2YzY1).",
                    parse_mode="markdown",
            ...
            await message.reply_text(
                text="Something went Wrong. Contact my [Support Group](https://t.me/joinchat/nvDxyrMPzloyNTE1).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/joinchat/nvDxyrMPzloyNTE1')
                ]
            ]
        ),
    ...
    if UPDATES_CHANNEL is not None:
        try:
            ...
            if user.status == "kicked":
                await bot.send_message(
                    chat_id=update.chat.id,
                    text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/joinchat/nvDxyrMPzloyNTE1).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
